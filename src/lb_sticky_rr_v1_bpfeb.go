...
type lb_sticky_rr_v1VariableSpecs struct {
	CurrentBackendIndex *ebpf.VariableSpec `ebpf:"current_backend_index"`
}
...
type lb_sticky_rr_v1Variables struct {
	CurrentBackendIndex *ebpf.Variable `ebpf:"current_backend_index"`
}
...
//
//go:embed lb_sticky_rr_v1_bpfeb.o
